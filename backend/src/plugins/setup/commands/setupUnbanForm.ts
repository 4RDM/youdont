...
export default async function ({ client, interaction }: CommandArgs) {
    ...
    return interaction.Reply([ Embed({ title: "Odwołanie od unbana", description: "Aby otworzyć formularz naciśnij przycisk poniżej", color: "#6f42c1" }) ], { components: [actionRow] });
}
